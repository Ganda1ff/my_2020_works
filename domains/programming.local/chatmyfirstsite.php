...
<nav>
  ...
  <a href="http://programming.local/myfirstsite.php" class="hvr-grow"><h1>ГЛАВНАЯ</h1></a>
  ...
  <div></div>
  <a class="button" href="http://programming.local/myfirstsite.php?#">РЕГИСТРАЦИЯ ▼</a>
...
<div align="left" class="input-wrapper" data-text="">
  ...
  <div><input   type="text" required > <div class="label-box"> <label>ИМЯ</label></div>
  <div><input  type="text" required>  <div class="label-box"> <label>ФАМИЛИЯ</label></div>
  ...
  <a class="button2" href="#">ЗАРЕГИСТРИРОВАТЬСЯ</a>
...
<pre><div class="search" id="input2"><input  placeholder="Введите ваш текст здесь"type="text" name="message" ></div> <p><input type="submit" value="Отправить"></p><a  class="btn-close trigger" href="#">ЗАКРЫТЬ ОКНО</a></pre>
