...
<div id="right">
<a href="/vkreg.php" onclick="alert('Сейчас вы перейдёте на сайт vk.com. Вы можете отменить это действие. Также вы должны понимать, что мы используем cookie.')"><input type="submit" value="Вход через VK" id="sub"></a>

<a href="/enter.php"><input type="submit" value="Войти в существующий аккаунт" id="sub3"></a>
</div>
...
<input type="submit" value="Вы должны войти или зарегистрироваться, чтобы голосовать" class="sub">